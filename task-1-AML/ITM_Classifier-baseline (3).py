...
class ITM_Classifier(ITM_DataLoader):
    ...
    # This version of create_vision_encoder utilizes modern transformer architectures from tensor flow hub
    def create_vision_encoder(self, projection_dims, dropout_rate):
        ...
        vit_model_url = "https://tfhub.dev/google/vit-base-patch16-224-in21k/1"
