...
learning_rate = 0.00095 # Perfect for the training
gamma = 0.995 
...
if learningAlg == "DQN":
    model = DQN("CnnPolicy", environment, seed=seed, learning_rate=learning_rate, gamma=gamma, buffer_size=35000, exploration_fraction=0.9, verbose=1)
